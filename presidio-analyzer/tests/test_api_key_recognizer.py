...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Temporary creds ASIAIOSFODNN7EXAMPLE issued",
         1, ((16, 36),), ((0.9, 0.9),)),
        ...
        ("id AKIAIOSFODNN7EXAMPLE and key "
         "ghp_A1b2C3d4E5f6G7h8I9j0K1l2M3n4O5p6Q7r8",
         2, ((3, 23), (32, 72)), ((0.9, 0.9), (0.9, 0.9))),
        ...
        ("sha1 is 356a192b7913b04c54574d18c28d46e6395428ab here",
         0, (), ()),
        ("commit 5aa01c0d84f6de2c1a89b6c2b1e7dfa3c9d0e1b2 done",
         0, (), ()),
        # A bare 40-character base64 run carries no credential marker.
        ("random 40 chars wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY alone",
         0, (), ()),
        # IAM unique ID prefixes identify roles/users, not credentials.
        ("AROADBQP57FF2AEXAMPLE is a role unique id",
         0, (), ()),
        ("AIDACKCEVSQ6C2EXAMPLE is a user unique id",
         0, (), ()),
        ("AGPAIOSFODNN7EXAMPLE is a user group unique id",
         0, (), ()),
        ...
        (f"{STRIPE_TEST_KEY} sandbox",
         0, (), ()),
        # Wrong lengths.
        ("ghp_A1b2C3d4E5f6G7h8I9j0K1l2M3n4O5p",
         0, (), ()),
        ("AKIAIOSFODNN7EXAMPL",
         0, (), ()),
        # Dotted base64 whose payload is not a JSON object is not a JWT.
        ("eyJhbGciOiJIUzI1NiJ9.bm90LWEtanNvbi1wYXlsb2Fk.c2lnbmF0dXJlaGVyZQ",
         0, (), ()),
        # fmt: on
    ],
)
